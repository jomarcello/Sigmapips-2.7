...
class TelegramService:
    def __init__(self, db: Database, stripe_service=None, bot_token: Optional[str] = None, proxy_url: Optional[str] = None, lazy_init: bool = False):
        ...
        self.webhook_url = os.getenv("WEBHOOK_URL", "https://sigmapips-27-production.up.railway.app")
...
async def analyze_from_signal_callback(self, update: Update, context=None) -> int:
    ...
    try:
        ...
        return MENU                 "stream": "ext://sys.stdout"
            },
            "file": {
                "class": "logging.FileHandler",
                "level": "DEBUG",
...
async def analyze_from_signal_callback(self, update: Update, context=None) -> int:
    ...
    try:
        ...
        return MENU             # Use the SIGNAL_ANALYSIS_KEYBOARD for consistency
            keyboard = SIGNAL_ANALYSIS_KEYBOARD
